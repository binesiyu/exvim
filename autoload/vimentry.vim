...
function vimentry#write_default_template()
    ...
    silent call append ( 0, [
                ...
                \ "",
                \ "-- ctrlp-project Options:",
                \ s:write_default( "enable_ctrlp_rg", "true", "{ true, false }" ),
                \ "-- init_open_file Options:",
                \ s:write_default( "enable_init_file", "false", "{ true, false }" ),
                \ s:write_default( "init_open_file", "", "" ),
                \ "-- gutentags Options:",
                \ s:write_default( "enable_gutentags", "true", "{ true, false }" ),
                \ s:write_default( "enable_gutentags_auto", "false", "{ true, false }" ),
                \ "",
                \ "-- ex-gsearch Options:",
                ...
                \ "",
                \ "-- ex-project Options:",
                \ s:write_default( "enable_project_browser", "false", "{ true, false }" ),
                \ s:write_default( "project_browser", "nerdtree", "{nerdtree }" ),
                \ "",
                \ "-- Project References:",
